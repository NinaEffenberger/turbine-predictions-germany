...
r3_orig_wind_speeds = CSV.read(
    "data/extracted_wind_speeds/MPI/ssp585/r1_orig_wind_speeds.csv",
    DataFrame,
)
...
era5_orig_wind_speeds_2023 = CSV.read(
    "data/extracted_wind_speeds/ERA5/2023/orig_wind_speeds.csv",
    DataFrame,
)
...
era5_orig_wind_speeds_2023 = rename_columns(era5_orig_wind_speeds_2023, "col9_")
...
r3_wind_speeds_gp_turbines = r3_wind_speeds_gp_turbines[:, :]
