...
testwind = 1:1:25
py"compute_windpower"(testwind, "E-101/3050")
...
CSV.write("data/extracted_wind_speeds/MPI/r3_wind_speeds_gp_turbines.csv", df)

df2 = DataFrame(orig_mean_speeds, :auto)
CSV.write("data/extracted_wind_speeds/MPI/r3_orig_wind_speeds.csv", df2)
