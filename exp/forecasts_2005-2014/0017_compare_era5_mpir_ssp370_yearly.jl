...
def compute_windpower(weather, turbine):
    ...
    return power
"""
py"compute_windpower"([1], "E-82/3000")
...
CSV.write("data/forecasts_cmip6/0017_ssp370_r1_orig.csv", df)
...
CSV.write("data/forecasts_cmip6/0017_ssp370_r1_orig_numturbines.csv", df)

filtered_df = CSV.read("data/turbine_locations/turbines_in_2012.csv", DataFrame)
...
power_r3mpi_location_over_time_all
df = DataFrame(vector = power_r3mpi_location_over_time_all)
CSV.write("data/forecasts_cmip6/0017_ssp370_r1.csv", df)
