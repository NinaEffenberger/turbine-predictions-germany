...
r3_orig_wind_speeds = CSV.read(
    "data/extracted_wind_speeds/MPI/r4_orig_wind_speeds.csv",
    DataFrame,
)
r3_wind_speeds_gp_turbines = CSV.read(
    "data/extracted_wind_speeds/MPI/r4_wind_speeds_gp_turbines.csv",
    DataFrame,
)
...
# year 2011+2012
r3_orig_wind_speeds = r3_orig_wind_speeds[:, 1:365*16+4]
r3_wind_speeds_gp_turbines = r3_wind_speeds_gp_turbines[indices, 1:365*16+4]
...
factor_era5_mean =
    cumsum(power_era5_mean_over_time)[365*8] / cumsum(true_generation)[365*8]
factor_era5_location =
    cumsum(power_era5_location_over_time)[365*8] /
    cumsum(true_generation)[365*8]
factor_r3mpi_mean =
    cumsum(power_r3mpi_mean_over_time)[365*8] / cumsum(true_generation)[365*8]
factor_r3mpi_location =
    cumsum(power_r3mpi_location_over_time)[365*8] /
    cumsum(true_generation)[365*8]
...
Legend(
    f[1, 2],
    [era5, era5_loc, mpi, mpi_loc, true_gen],
    [
        L"\mathrm{ERA5\;mean}",
        L"\mathrm{ERA5\;GP}",
        L"\mathrm{MPI\;mean}",
