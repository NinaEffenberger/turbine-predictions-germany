...
data_u = Dataset(
    "data/generated_data/MPI/uas_r4/outfile_46.66667175292969_55.833335876464844_5.0_15.416666984558105.nc",
    "r",
)
data_v = Dataset(
    "data/generated_data/MPI/vas_r4/outfile_46.66667175292969_55.833335876464844_5.0_15.416666984558105.nc",
    "r",
)
...
CSV.write("data/extracted_wind_speeds/MPI/r4_wind_speeds_gp_turbines.csv", df)

df2 = DataFrame(orig_mean_speeds, :auto)
CSV.write("data/extracted_wind_speeds/MPI/r4_orig_wind_speeds.csv", df2)
