...
data_u = Dataset(
    "data/generated_data/MPI/ssp585/uas_r1/outfile_46.66667175292969_55.833335876464844_5.0_15.416666984558105.nc",
    "r",
)

data_v = Dataset(
    "data/generated_data/MPI/ssp585/vas_r1/outfile_46.66667175292969_55.833335876464844_5.0_15.416666984558105.nc",
    "r",
)
...
CSV.write(
    "data/extracted_wind_speeds/MPI/ssp585/r1_wind_speeds_gp_turbines.csv",
    df,
)

df2 = DataFrame(orig_mean_speeds, :auto)
CSV.write("data/extracted_wind_speeds/MPI/ssp585/r1_orig_wind_speeds.csv", df2)
