...
factor_ssp126_orig = cumsum(ssp126_orig)[365*8] / cumsum(true_generation)[365*8]
factor_ssp126_turbines =
    cumsum(ssp126_turbines)[365*8] / cumsum(true_generation)[365*8]
factor_ssp370_orig = cumsum(ssp370_orig)[365*8] / cumsum(true_generation)[365*8]
factor_ssp370_turbines =
    cumsum(ssp370_turbines)[365*8] / cumsum(true_generation)[365*8]
factor_ssp245_orig = cumsum(ssp245_orig)[365*8] / cumsum(true_generation)[365*8]
factor_ssp245_turbines =
    cumsum(ssp245_turbines)[365*8] / cumsum(true_generation)[365*8]
factor_ssp585_orig = cumsum(ssp585_orig)[365*8] / cumsum(true_generation)[365*8]
factor_ssp585_turbines =
    cumsum(ssp585_turbines)[365*8] / cumsum(true_generation)[365*8]
factor_era5_turbines =
    cumsum(era5_turbines)[365*8] / cumsum(true_generation)[365*8]
factor_era5_orig = cumsum(era5_orig)[365*8] / cumsum(true_generation)[365*8]
