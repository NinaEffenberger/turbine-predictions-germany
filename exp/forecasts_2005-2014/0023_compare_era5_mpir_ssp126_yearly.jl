...
CSV.write("data/forecasts_cmip6/0021_ssp126_r1_orig.csv", df)
...
CSV.write("data/forecasts_cmip6/0021_ssp126_r1.csv", df)
...
save("plots/july/0021_cumulative_mpi126.pdf", f)
f
