"""
Generate one file for location and non-location aware power prediction of ERA5 from 2015 to 2023. 
"""
using CSV
using DataFrames
using PyCall
...
r3_orig_wind_speeds = hcat(
    rename_columns(data_frames["orig_wind_speeds_2015"], "1"),
    rename_columns(data_frames["orig_wind_speeds_2016"], "2"),
    rename_columns(data_frames["orig_wind_speeds_2017"], "3"),
    rename_columns(data_frames["orig_wind_speeds_2018"], "4"),
    rename_columns(data_frames["orig_wind_speeds_2019"], "5"),
    rename_columns(data_frames["orig_wind_speeds_2020"], "6"),
    rename_columns(data_frames["orig_wind_speeds_2021"], "7"),
    rename_columns(data_frames["orig_wind_speeds_2022"], "8"),
    rename_columns(data_frames["orig_wind_speeds_2023"], "9"),
)
...
CSV.write("data/forecasts_era5/0032_era5_orig.csv", df)
...
CSV.write("data/forecasts_era5/0032_era5_turbines.csv", df)