"""
Predict wind speeds per turbine location for Germany with SSP126 including the first and second run of the MPI model. Predictions are from 2025 to 2025. Hyperparameter optimization is in other/0001_hyperparam_historical.jl.
"""
using AbstractGPs
