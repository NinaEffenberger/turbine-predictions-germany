"""
Predict wind speed variance per turbine location for Germany with SSP370 including the first and second run of the MPI model. Predictions are for 2050 only. Hyperparameter optimization is in other/0001_hyperparam_historical.jl.
"""
using AbstractGPs
