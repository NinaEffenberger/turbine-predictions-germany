"""
Predict wind power per turbine location for Germany with SSP126 including the first and second run of the MPI model, wind speeds are extracted in 0001prob_forcasts_speed_optim_ssp126.jl. Predictions are from 2025 to 2050. Turbine data is generated in other/0002_find_turbine.jl.  
"""
using CSV
using DataFrames
using PyCall
