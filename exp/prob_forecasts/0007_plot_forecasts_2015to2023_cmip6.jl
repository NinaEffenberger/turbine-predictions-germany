...
with_theme(T) do
    ...
    #save(
    #    "plots/paper/pdfs/0037_numtur_power_generation_cmip6_era5_relative_new_legend.pdf",
    #    f,
    #)
    f
end
...
with_theme(T) do
    ...
    lg = Legend(
        f[0, 1],
        [ssp370t, era5t, num_tur, ssp370_trained],
        [
            #L"\mathrm{126t\;(83,27%)}",
            #L"\mathrm{SSP126\;(63.32%,\;83.27%)}",
            #L"\mathrm{245t\;(105,89%)}",
    ...
    save("plots/paper/0007_power_generation_cmip6_optim_hyperparams.pdf", f)
    f
end
