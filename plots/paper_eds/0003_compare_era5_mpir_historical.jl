"""
Generate figure of 2011-2014 predictions using CMIP6 and ERA5, location-aware and non location-aware relative to actual power generation as reported by TSOs.
"""
using CSV
using DataFrames
using PyCall
